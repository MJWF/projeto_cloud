...
class MainPageForUser extends State<MainPageForUserState> {
  ...
  Future<void> fetchDataFromAPI() async {
    final response = await http.post(
        Uri.parse('http://192.168.132.138:5000/return_marca'));
  ...
  Future<void> fetchModelsFromBrand(String brand) async {
    final response = await http.post(Uri.parse('http://192.168.132.138:5000/return_modelo'),
        body: {
          'marca': brand,
        });
  ...
  Future<void> fetchFinalSearch(String brand, String model, String year) async {
    ...
    final response = await http.post(Uri.parse('http://192.168.132.138:5000/return_carro_avancado'),
        body: {
          'marca': brand,
          'modelo': model,
          'ano': year
